...
const Banner = () => {
  return (
    <section className='min-h-[65vh] lg:min-h-[88vh] flex items-center bg-main' id='home'>
      <div className='container mx-auto'>
        <div className='flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12'>
          <div className='flex-1 text-center font-secondary lg:text-left'>
            ...
            <motion.p variants={fadeIn('up', 0.5)} initial="hidden" whileInView={'show'} viewport={{ once: false, amount: 0.7 }} className='lg:p-3 p-1 lg:mt-4 mt-1 lg:mb-8 mb-2 lg:text-[36px] text-[36px] font-secondary font-semibold max-w-lg mx-auto lg:mx-0 text-slate-700 lea'>Hi, i am Ayomide Olanrewaju. I am a <TypeAnimation sequence={[
                'Front-end Developer',
                2000,
                'React Developer',
                2000,
